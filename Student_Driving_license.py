...
# Define the function
def license() : 
    dr_license=543216987
    dr_name="dhanush"
    label_id["text"]=dr_license
    label_name["text"]=dr_name
    label_dob["text"]="JAN 14 2010"
    label_pin["text"]="560094"
    label_address["text"]="Bangalore,Karnataka"
    label_vehicle_type["text"]="Two Four"
# Create a button
button1=Button(root,command=license,text="show details")
button1.pack()
